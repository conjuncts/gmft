...
from gmft.formatters.intervalic import IntervalicConfig, IntervalicFormattedTable
...
@dataclass
class DITRFormatConfig(IntervalicConfig):
    """
...
class DITRFormattedTable(IntervalicFormattedTable):
    """
